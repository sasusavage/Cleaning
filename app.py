...
def _add_security_headers(response):
    ...
    response.headers.setdefault(
        ...
        "img-src 'self' data: blob: https://res.cloudinary.com https://maps.gstatic.com https://maps.googleapis.com https://*.tile.openstreetmap.org; "
        "frame-src https://js.stripe.com https://www.google.com https://www.openstreetmap.org; "
...
DEFAULT_HERO_CONTENT = {
    ...
    'announcement_text': 'FREE ESTIMATES • INSURED & BONDED',
    'announcement_bg_color': '#000000',
    'announcement_text_color': '#ffffff',
    'editorial_label': 'Professional Cleaning',
    'editorial_tracking': 0.1,
    'title': 'Your Space, Perfectly Clean',
    'title_color': '#ffffff',
    'subtitle': 'Trusted cleaning services for homes and businesses. Reliable, thorough, and eco-friendly.',
    ...
    'stat1_label': 'Client Satisfaction',
    'stat1_value': '98%',
    'stat2_label': 'Homes Served',
    'stat2_value': '1000+',
    'stat3_label': 'Same-Day Service',
    'stat3_value': 'Available',
